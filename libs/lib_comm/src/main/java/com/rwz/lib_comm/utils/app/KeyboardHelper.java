...
public class KeyboardHelper {
    ...
    public static void setVisibilityEventListener(final Activity activity,
        ...
        activity.getApplication()
                .registerActivityLifecycleCallbacks(new KBActivityLifecycleCallbacks(activity) {
                    @Override
    ...
    public static abstract class KBActivityLifecycleCallbacks implements Application.ActivityLifecycleCallbacks {

        private final Activity mTargetActivity;

        public KBActivityLifecycleCallbacks(Activity targetActivity) {
